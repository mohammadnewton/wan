...
function TransformationsHome() {
  return (
    <section className="h-[40vh] flex justify-center flex-col px-8 md:px-36 gap-4" style={{ backgroundImage: `url(${transformationBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
